...
# summarizes sales information for product categories
...
# detailed information about products filter by date
...
# find revenue information for a specific category 
...
# get Cumulative Revenue Group By Date
...
# get Average Subtotal Group By Date use OLAP
...
# get rank1 Selling Product in Each Category (excluding products with a price <= 50)
